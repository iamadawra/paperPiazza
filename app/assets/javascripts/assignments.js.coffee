...
site.assignments.new = ->
  ...
  addHiddensFor = (qid, resubmitDelay, questionIndex) ->
    ...
    if resubmitDelay and resubmitDelay != ""
      form.append("<input type='hidden' name='assignment[entries_attributes][#{questionIndex}][resubmit_delay]' id='assignment_entries_#{questionIndex}_resubmit_delay' value='#{resubmitDelay}'/>")
